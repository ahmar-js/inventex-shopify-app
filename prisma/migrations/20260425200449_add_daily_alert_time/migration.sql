...
INSERT INTO "new_AlertSettings" ("alertEmails", "alertFrequency", "createdAt", "id", "lowStockEnabled", "shop", "updatedAt") SELECT "alertEmails", "alertFrequency", "createdAt", "id", "lowStockEnabled", "shop", "updatedAt" FROM "AlertSettings";
